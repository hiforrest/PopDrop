...
if ($ahkContent -notmatch ';@Ahk2Exe-SetVersion\s+2\.0\.12\.0'
    -or $ahkContent -notmatch 'APP_VERSION\s*:=\s*"2\.0\.12"') {
    Write-Err "Source version is not PopDrop v2.0.12"
    exit 15
}
Write-OK "Source version check passed: PopDrop v2.0.12"
